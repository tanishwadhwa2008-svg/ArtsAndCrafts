...
import { BlockEditDialog } from './content/BlockEditDialog.js';
import { BLOCK_LABELS } from './content/block-meta.js';
...
export function HomepagePage() {
  ...
  const publishMut = useUpdateHomePage();
        ...
        <>
          ...
          {blocks.length === 0 ? (
            <p className="py-16 text-center text-muted">
              No blocks yet. Add your first block to build the homepage.
            </p>
          ) : (
